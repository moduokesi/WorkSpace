...
<head>
    ...
    <meta charset="utf-8">
    <title>imageLoader/registerLoaders.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">imageLoader/registerLoaders.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import wadors from './wadors/index.js';
