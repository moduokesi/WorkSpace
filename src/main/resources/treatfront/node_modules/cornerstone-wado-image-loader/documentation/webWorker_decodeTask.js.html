...
<head>
    ...
    <meta charset="utf-8">
    <title>webWorker/decodeTask.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">webWorker/decodeTask.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { initialize as initializeJPEG2000 } from '../shared/decoders/decodeJPEG2000.js';
