...
<head>
    ...
    <meta charset="utf-8">
    <title>shared/calculateMinMax.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">shared/calculateMinMax.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import getMinMax from './getMinMax.js';
