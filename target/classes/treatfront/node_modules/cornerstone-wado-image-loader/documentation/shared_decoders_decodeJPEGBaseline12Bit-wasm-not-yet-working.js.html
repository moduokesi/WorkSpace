...
<head>
    ...
    <meta charset="utf-8">
    <title>shared/decoders/decodeJPEGBaseline12Bit-wasm-not-yet-working.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">shared/decoders/decodeJPEGBaseline12Bit-wasm-not-yet-working.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import libjpegTurbo12Factory from '@cornerstonejs/codec-libjpeg-turbo-12bit/dist/libjpegturbo12wasm.js';
